...
<head>
  <meta charset="UTF-8">
  <title>Demo</title>
  <scriptt src="https://cdn.tailwindcss.com></script>
</head>
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/contact" class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium" aria-current="page">Contact</a>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
